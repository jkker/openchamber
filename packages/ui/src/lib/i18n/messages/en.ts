...
export const dict = {
  ...
  'sessions.sidebar.group.pagination.prev': 'Prev',
  'sessions.sidebar.group.pagination.next': 'Next',
  'sessions.sidebar.group.pagination.page': 'Page {current} / {total}',
  'sessions.sidebar.group.pagination.subagents': 'Subagents {current}/{total}',
  'sessions.sidebar.searching': 'Searching sessions...',
  ...
  'chat.messageBody.footer.totalTime': 'Total time',
  'chat.messageBody.footer.totalTimeAria': 'Total time: {{value}}',
  'chat.messageBody.footer.tps': 'Tokens per second',
  'chat.messageBody.footer.tpsAria': 'Tokens per second: {{value}}',
  'chat.messageBody.footer.ttft': 'Time to first token',
  'chat.messageBody.footer.ttftAria': 'Time to first token: {{value}}',
  'chat.messageBody.footer.completedAt': 'Completed at',
  'chat.messageBody.footer.completedAtAria': 'Completed at: {{value}}',
