export const settingsDict = {
  ...
  'settings.voice.page.preview.edgeTtsLine': 'Hello! This is a preview of Edge TTS.',
  'settings.voice.page.preview.speechSdkLine': 'Hello! This is a preview of the Speech SDK.',
  'settings.voice.page.provider.edgeTts': 'Edge TTS',
  'settings.voice.page.provider.speechSdk': 'Speech SDK',
  'settings.voice.page.tooltip.edgeTts': 'Microsoft Edge Read Aloud. No API key required. Runs on server.',
  'settings.voice.page.tooltip.speechSdk': 'Multi-provider TTS via @speech-sdk/core. Supports OpenAI, ElevenLabs, Deepgram, and more.',
  'settings.voice.page.field.sdkProvider': 'SDK Provider',
  'settings.voice.page.field.sdkApiKey': 'API Key',
  'settings.voice.page.field.sdkApiKeyHint': 'Client-supplied key. Falls back to server environment variable if empty.',
  'settings.voice.page.field.edgeVoice': 'Edge TTS Voice',
  'settings.voice.page.field.timestamps': 'Word Timestamps',
  'settings.voice.page.field.timestampsHint': 'Request word-level timestamps for playback alignment (where supported).',
  'settings.voice.page.field.edgeTtsNote': 'Note: edge-tts-universal is AGPL-3.0. No API key required.',
