export const settingsDict = {
  ...
  'settings.agents.page.field.defaultThinking': 'Default Thinking',
  'settings.agents.page.field.defaultThinkingTooltip': 'Default reasoning variant when this agent is active',
  'settings.agents.page.field.thinkingPlaceholder': 'Thinking',
  'settings.agents.page.field.clearThinkingAria': 'Clear thinking override',
  'settings.agents.page.option.default': 'Default',
